...
def plot_learning_curve(logfile_dir, result_lists):
    ...
    # extract data from result_lists
    train_loss_list = [x.item() if type(x) is not float else x for x in result_lists['train_loss']]
    train_acc_list = [x.item() if type(x) is not float else x for x in result_lists['train_acc']]
    val_loss_list = [x.item() if type(x) is not float else x for x in result_lists['val_loss']]
    val_acc_list = [x.item() if type(x) is not float else x for x in result_lists['val_acc']]
